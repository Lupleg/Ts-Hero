...
JavaScript, like most programming languages has a concept of [primitive data types](https://lupleg.dev/challenge/primitive-data-types). Primitive data types are things like `string`, `number` and `boolean`.
